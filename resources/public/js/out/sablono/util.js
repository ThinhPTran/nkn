...
var len__21393__auto___30852 = arguments.length;
var i__21394__auto___30853 = (0);
while(true){
if((i__21394__auto___30853 < len__21393__auto___30852)){
args__21400__auto__.push((arguments[i__21394__auto___30853]));

var G__30854 = (i__21394__auto___30853 + (1));
i__21394__auto___30853 = G__30854;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq30851){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30851));
});
...
var vec__30858 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__30860;
var words = seq__30859__$1;
...
var G__30862 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__30862,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__30862;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__30863_SHARP_){
if(typeof p1__30863_SHARP_ === 'string'){
return p1__30863_SHARP_;
} else {
return cljs.core.seq.call(null,p1__30863_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1482468812452